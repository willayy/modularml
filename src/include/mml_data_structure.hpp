...
class MML_DataStructure : public DataStructure<T> {
   ...
   private:
    ...
    /**
     * @brief Given the indices and the shape of the data structure calculates the
     * offset that the indices represent.
     * @param indices A vector of integers that each represent a direction in a
     * diemension.
     */
