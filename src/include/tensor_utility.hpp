...
template <typename T>
array_mml<T> generate_random_array_mml_integral(uli lo_sz = 1, uli hi_sz = 5, T lo_v = 1, T hi_v = 10);
...
template <typename T>
array_mml<T> generate_random_array_mml_real(uli lo_sz = 1, uli hi_sz = 5, T lo_v = 1, T hi_v = 100);
