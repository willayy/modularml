...
template <typename T>
void TensorOperationsModule::set_add_ptr(void (*ptr)(const shared_ptr<const Tensor<T>> a,
...
template <typename T>
void TensorOperationsModule::set_subtract_ptr(void (*ptr)(const shared_ptr<Tensor<T>> a,
...
template <typename T>
void TensorOperationsModule::set_multiply_ptr(void (*ptr)(const shared_ptr<Tensor<T>> a,
                                                          const T b,
                                                          shared_ptr<Tensor<T>> c)) {
...
template <typename T>
void TensorOperationsModule::set_equals_ptr(bool (*ptr)(const shared_ptr<Tensor<T>> a,
                                                        const shared_ptr<Tensor<T>> b)) {
  this->equals_ptr = ptr;
}

template <typename T>
void TensorOperationsModule::set_elementwise_ptr(void (*ptr)(const shared_ptr<const Tensor<T>> a,
...
template <typename T>
void TensorOperationsModule::set_elementwise_in_place_ptr(void (*ptr)(const shared_ptr<Tensor<T>> a,
                                                                      const function<T(T)>& f)) {
  this->elementwise_in_place_ptr = ptr;
}

template <typename T>
void TensorOperationsModule::set_gemm_ptr(void (*ptr)(int TA, int TB, int M, int N, int K, T ALPHA,
...
template <typename T>
void TensorOperationsModule::set_arg_max_ptr(int (*ptr)(const shared_ptr<const Tensor<T>> a)) {
...
template <typename T>
void TensorOperationsModule::multiply(const shared_ptr<Tensor<T>> a,
                                         const T b,
                                         shared_ptr<Tensor<T>> c) {
...
void TensorOperationsModule::elementwise_in_place(
    const shared_ptr<Tensor<T>> a, function<T(T)> f) {
  this->elementwise_in_place_ptr(a, f);
}

template <typename T>
void TensorOperationsModule::gemm(int TA, int TB, int M, int N, int K,
