...
PoolingNode_mml::PoolingNode_mml(std::string input,
                                 ...
                                 array_mml<uli> strides, std::string auto_pad,
                                 uli ceil_mode, array_mml<uli> dilations,
                                 array_mml<uli> pads)
          ...
          for (uli i = 2; i < 4; i++) {
            if (auto_pad == "VALID") {
              ...
              if (ceil_mode) {
                ...
                output_shape[i] = static_cast<uli>(floor(
