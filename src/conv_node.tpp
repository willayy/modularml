...
void ConvNode<T>::forward() {
  ...
  array_mml<uli> result_shape({W->get_shape()[0], im2col_output->get_shape()[1]});
...
template <typename T>
uli ConvNode<T>::get_batch_size() const { return batch_size; }

template <typename T>
uli ConvNode<T>::get_in_channels() const { return in_channels; }

template <typename T>
uli ConvNode<T>::get_in_height() const { return in_height; }

template <typename T>
uli ConvNode<T>::get_in_width() const { return in_width; }

template <typename T>
uli ConvNode<T>::get_kernel_height() const { return kernel_height; }

template <typename T>
uli ConvNode<T>::get_kernel_width() const { return kernel_width; }

template <typename T>
uli ConvNode<T>::get_out_channels() const { return out_channels; }

template <typename T>
uli ConvNode<T>::get_stride_height() const { return stride[0]; }

template <typename T>
uli ConvNode<T>::get_stride_width() const { return stride[1]; }

template <typename T>
uli ConvNode<T>::get_padding_top() const { return padding[0]; }

template <typename T>
uli ConvNode<T>::get_padding_bottom() const { return padding[1]; }

template <typename T>
uli ConvNode<T>::get_padding_left() const { return padding[2]; }

template <typename T>
uli ConvNode<T>::get_padding_right() const { return padding[3]; }

template <typename T>
uli ConvNode<T>::get_out_height() {
  return (get_in_height() + get_padding_top() + get_padding_bottom() - get_kernel_height()) / get_stride_height() + 1;
}

template <typename T>
uli ConvNode<T>::get_out_width() {
