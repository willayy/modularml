...
template array_mml<DT> ArrayUtils::generate_random_array_mml_real<DT>(size_t, size_t, DT, DT);

#define _ARRAY_UTILS_INTEGER(DT) \
template array_mml<DT> ArrayUtils::generate_random_array_mml_integral<DT>(size_t, size_t, DT, DT);
