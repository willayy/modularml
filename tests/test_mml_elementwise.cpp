...
TEST(test_mml_elementwise, test_elementwise_apply) {
  ...
  shared_ptr<Tensor<float>> t1 = make_shared<Tensor_mml<float>>(tensor_mml({3, 3}, {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f}));
  shared_ptr<Tensor<float>> t2 = make_shared<Tensor_mml<float>>(tensor_mml({3, 3}, {1.0f, 4.0f, 9.0f, 16.0f, 25.0f, 36.0f, 49.0f, 64.0f, 81.0f}));
