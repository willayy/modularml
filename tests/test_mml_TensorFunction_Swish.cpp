...
TEST(test_mml_TensorFunction_Swish, test_SwishFunction) {
   ...
   */
  shared_ptr<Tensor<float>> expected_func = tensor_mml_p<float>({3, 3}, {-0.2689f, 0.0f, 0.7311f,
   ...
   * to each element.
   */
  shared_ptr<Tensor<float>> expected_derivative = tensor_mml_p<float>({3, 3}, {0.0723f, 0.5000f, 0.9277f,
   ...
   * to each element.
   */
  shared_ptr<Tensor<float>> expected_primitive = tensor_mml_p<float>({3, 3}, {1.0443f, 0.6931f, 1.0443f,
...
TEST(test_mml_TensorFunction_Swish, test_SwishFunction_double) {
   ...
   * @brief Expected Tensor after the Swish function is applied to each element.
   */
  shared_ptr<Tensor<double>> expected_func = tensor_mml_p<double>({3, 3}, {-0.268941, 0.0, 0.731059,
   ...
   * to each element.
   */
  shared_ptr<Tensor<double>> expected_derivative = tensor_mml_p<double>({3, 3}, {0.072329, 0.5, 0.927671,
   ...
   * to each element.
   */
  shared_ptr<Tensor<double>> expected_primitive = tensor_mml_p<double>({3, 3}, {1.044287, 0.693147, 1.044287,
