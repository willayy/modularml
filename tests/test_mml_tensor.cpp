...
TEST(test_mml_tensor, test_slicing_1) {
  ...
  shared_ptr<Tensor<int>> expected_t2 = tensor_mml_p({3}, {1,
                                                           4,
                                                           7});
  shared_ptr<Tensor<int>> expected_t3 = tensor_mml_p({3}, {2,
                                                           5,
                                                           8});
  shared_ptr<Tensor<int>> expected_t4 = tensor_mml_p({3}, {3,
                                                           6,
                                                           9});
