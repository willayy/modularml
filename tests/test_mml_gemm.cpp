...
TEST(test_mml_gemm, test_check_tensor_properties_1) {
  const std::shared_ptr<Tensor<float>> a =
      TensorFactory::create_tensor<float>({2, 3, 1}, {1, 2, 3, 4, 5, 6});
  const std::shared_ptr<Tensor<float>> b =
      TensorFactory::create_tensor<float>({3, 2}, {4, 5, 6, 7, 8, 9});
  const std::shared_ptr<Tensor<float>> c =
      TensorFactory::create_tensor<float>({2, 2});
...
TEST(test_mml_gemm, test_check_C_dimensions_1) {
  ...
  const std::shared_ptr<Tensor<float>> b =
      TensorFactory::create_tensor<float>({3, 2}, {4, 5, 6, 7, 8, 9});
  const std::shared_ptr<Tensor<float>> c =
      TensorFactory::create_tensor<float>({3, 2});
  const float alpha = 1;
  const float beta = 0;
  ASSERT_THROW(
      gm_f->gemm_inner_product(0, 0, 2, 2, 3, alpha, a, 3, b, 2, beta, c, 2),
...
TEST(test_mml_gemm, gemm_128x128_float) {
  ...
  TensorOperationsModule::gemm<float>(0, 0, 128, 128, 128, 1, a, 128, b, 128, 0,
                                      c, 128);
...
TEST(test_mml_gemm, gemm_256x256_float) {
  ...
  TensorOperationsModule::gemm<float>(0, 0, 256, 256, 256, 1, a, 256, b, 256, 0,
                                      c, 256);
...
TEST(test_mml_gemm, gemm_122x122_float) {
  ...
  TensorOperationsModule::gemm<float>(0, 0, 122, 122, 122, 1, a, 122, b, 122, 0,
                                      c, 122);
...
TEST(test_mml_gemm, gemm_250x250_float) {
  ...
  TensorOperationsModule::gemm<float>(0, 0, 250, 250, 250, 1, a, 250, b, 250, 0,
                                      c, 250);
